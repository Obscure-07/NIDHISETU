        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            ...
            {/* Info Cards */}
                        <View style={styles.infoSection}>
                                {renderInfoRow({ icon: 'briefcase-outline', label: t('Loan Category'), value: userProfile.loanCategory })}
                                {renderInfoRow({ icon: 'call-outline', label: t('Phone'), value: userProfile.phone })}
                                {renderInfoRow({ icon: 'mail-outline', label: t('Email'), value: userProfile.email })}
                                {renderInfoRow({ icon: 'location-outline', label: t('Address'), value: userProfile.address })}
                                {renderInfoRow({
